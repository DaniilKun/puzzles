...
window.pageSlider = new core('._slide-one', {
  direction: "vertical",
  slidesPerView: 2,
  speed: 2000,
  spaceBetween: 50,
...
window.pageSliderTwo = new core('.swiper-two', {
  direction: "vertical",
  slidesPerView: 2,
  speed: 2000,
  spaceBetween: 50,
...
window.pageSliderThree = new core('._painters-slider', {
  direction: "horizontal",
  slidesPerView: 1,
  speed: 2000,
  loop: true,
...
window.pageSliderFour = new core('._text-slider', {
  direction: "vertical",
  slidesPerView: 1,
  speed: 2000,
  loop: false,
...
let splitted_location = document.location.href.split("?");

if (splitted_location.length > 1) {
    try {
        window.pageSliderTwo.slideTo(splitted_location[1].split("slide=")[1], false, false);
    } catch {};
    try {
        window.pageSlider.slideTo(splitted_location[1].split("slide=")[1], false, false);
    } catch {};
} else if (window.startSlide != undefined) {
    try {
        window.pageSliderTwo.slideTo(window.startSlide, false, false);
    } catch {};
    try {
        window.pageSlider.slideTo(window.startSlide, false, false);
    } catch {};
}

let other_puzzles_link = document.getElementsByClassName("switch_puzzle");
for (let i = 0; i < other_puzzles_link.length; i++) {
    other_puzzles_link[i].onclick = function(e) {
        let elem = e.target || e.srcElement;
        elem = elem.closest("a");

        elem.setAttribute("href", elem.getAttribute("href") + "?slide=" + (pageSlider.activeIndex || pageSliderTwo.activeIndex));
    }
}
